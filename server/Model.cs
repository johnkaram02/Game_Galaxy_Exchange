...
namespace game_galaxy_exchange.Server
{
    public class Model
    {
        ...
        public class GameGalaxyExchangeContext : DbContext
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:gamegalaxyexchange-sql.database.windows.net,1433;Initial Catalog=Game_Galaxy_Exchange;Persist Security Info=False;User ID=gameadmin;Password=OnRamp2024;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
